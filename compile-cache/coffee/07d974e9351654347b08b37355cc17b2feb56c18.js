(function() {
  var $, $$, BranchDialog, BranchView, CommitDialog, ConfirmDialog, DiffView, FileView, FlowDialog, GitControlView, LogView, MenuView, MergeDialog, PushDialog, View, git, _ref,
