(function() {
  ...
  LinterViews = (function() {
    function LinterViews(linter) {
      ...
      this._bottomTabFile.initialize("File", (function(_this) {
        return function() {
    ...
    LinterViews.prototype.setShowBubble = function(_showBubble) {
      this._showBubble = _showBubble;
    };

    LinterViews.prototype.setUnderlineIssues = function(_underlineIssues) {
      this._underlineIssues = _underlineIssues;
    };
    ...
    LinterViews.prototype.attachBottom = function(statusBar) {
      ...
      return this._statusTiles.push(statusBar.addRightTile({
    ...
    LinterViews.prototype._renderPanel = function() {
      ...
      this._messages.forEach((function(_this) {
        return function(message) {
          ...
          if (_this._underlineIssues && message.currentFile && message.range) {
